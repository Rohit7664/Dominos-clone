    ...
    <div className="paymentContainer-pk">
      <div className="payment-left-div-pk">
        <div style={{ marginBottom: "-10px" }}>
          <span
            className="payment-left-top-heading-pk"
            style={{ fontSize: "30px" }}
          >
            Payment Gateway:
          </span>
        ...
        <div className="payment-method-container-pk box-shadow-pk">
          <div className="payment-method-div-pk">
            ...
            <div
              className="payment-method-right-pk"
      ...
      <div className="payment-right-div-pk">
        <div>
          <b>
            ...
            >
              <span
                className="payment-address-title-pk"
                style={{ color: "white" }}
              >
                Delivery Address
              </span>
          ...
          <div
            className="payment-addr-cont-pk box-shadow-pk"
            style={{ marginBottom: "10px" }}
          >
            <div className="addr-location-icon-div-pk">
              <div className="addr-location-icon-pk"></div>
              <div className="addr-text-div-pk">
                <p className="addr-location-main-pk payment-method-text-p-tag-pk">
                  {ObjData.city}
                </p>
                <p className="addr-location-sub-pk payment-method-text-p-tag-pk">
                  {ObjData.address}
                </p>
              </div>
            </div>
          ...
          <div className="price-detail-cont-pk box-shadow-pk">
            <div className="payment-addr-cont-pk">
              <div className="price-details-cont-pk">
                ...
                <div className="price-text-div-pk">
                  <span className="tax-charges-cont-pk">
                    Taxes and Charges
                    <div>
                      <div className="tax-details-div-pk">
                        <b>i</b>
                      </div>
                    </div>
                  </span>
                ...
                <div className="break-line-pk"></div>
                <p className="payment-mode-note-pk">
                  <span>Note </span>- This is not an invoice. Invoice will be
                  supplied along with delivery of goods with complete tax
                  categorization.
                </p>
              </div>
            </div>
